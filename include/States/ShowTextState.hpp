...
class ShowTextState : public GameState {
public:
	ShowTextState(StateManager& manager, sf::Texture frame, const sf::Vector2f& textPosition, const std::string& text, float charDuration);
