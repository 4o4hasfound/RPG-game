...
EndGameState::EndGameState(StateManager& manager, sf::Texture frame, const sf::Vector2f& textPosition, const std::string& text, float charDuration)
	: m_frame(frame)
	, m_progress(0.0f)
...
void EndGameState::onCreate() {}
void EndGameState::onDestroy() {}
void EndGameState::reset() {}
void EndGameState::update(sf::Time dt) {
